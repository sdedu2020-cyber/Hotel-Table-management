...
const App: React.FC = () => {
  const [tables, setTables] = useLocalStorageState<Table[]>('restaurant_tables', INITIAL_TABLES);
  const [menuItems, setMenuItems] = useLocalStorageState<MenuItem[]>('restaurant_menu', MENU_ITEMS);
  const [categories, setCategories] = useLocalStorageState<string[]>('restaurant_categories', ['Default']);
